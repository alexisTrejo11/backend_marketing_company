...
class CustomerCompanyTest {
  ...
  void setUp() {
    ...
    validCompanyProfile = CompanyProfile.builder()
        ...
        .revenue(new AnnualRevenue(new BigDecimal("500000"), Currency.getInstance("USD"),
            AnnualRevenue.RevenueRange.BETWEEN_100K_1M))
        .foundingYear(2015)
        .build();
  ...
  void upgradeToEnterprise_ValidRevenue_ShouldUpgradeAndRegisterEvent() {
    ...
    AnnualRevenue enterpriseRevenue = new AnnualRevenue(new BigDecimal("5000000"), Currency.getInstance("USD"),
        AnnualRevenue.RevenueRange.BETWEEN_1M_10M);
    ...
    CompanyUpgradedToEnterpriseEvent event = (CompanyUpgradedToEnterpriseEvent) company.getDomainEvents().stream()
  ...
  void isStartup_CompanyFoundedLessThan5YearsAgo_ShouldReturnTrue() {
    ...
    CompanyProfile startupProfile = CompanyProfile.builder()
        ...
        .revenue(new AnnualRevenue(new BigDecimal("100000"), Currency.getInstance("USD"),
            AnnualRevenue.RevenueRange.BETWEEN_100K_1M))
  ...
  void isHighValueClient_HighRevenue_ShouldReturnTrue() {
    ...
    CompanyProfile highValueProfile = CompanyProfile.builder()
        ...
        .revenue(new AnnualRevenue(new BigDecimal("20000000"), Currency.getInstance("USD"),
            AnnualRevenue.RevenueRange.BETWEEN_10M_100M))
        .foundingYear(2010)
        .build();
