...
public class UserQueryServiceImpl implements UserQueryService {
  ...
  @Override
  @Transactional(readOnly = true)
  public User handleGetUserByEmail(GetUserByEmailQuery query) {
  ...
  @Override
  @Transactional(readOnly = true)
  public Page<User> handleSearchUsers(SearchUsersQuery query) {
  ...
  @Override
  @Transactional(readOnly = true)
  public Page<User> handleGetActiveUsers(GetActiveUsersQuery query) {
  ...
  @Override
  @Transactional(readOnly = true)
  public Page<User> handleGetUsersByRole(GetUsersByRoleQuery query) {
  ...
  @Override
  @Transactional(readOnly = true)
  public UserStatistics handleGetUserStatistics(GetUserStatisticsQuery query) {
