...
public interface JpaInteractionRepository extends JpaRepository<InteractionEntity, String> {
  ...
  Page<InteractionEntity> findInteractionsRequiringFollowUp(@Param("followUpTypes") List<FeedbackType> followUpTypes,
      Pageable pageable);
  ...
  @Query("SELECT i FROM InteractionEntity i WHERE i.feedbackType IN :positiveTypes")
  Page<InteractionEntity> findPositiveInteractions(@Param("positiveTypes") List<FeedbackType> positiveTypes,
      Pageable pageable);
  ...
  Page<InteractionEntity> findNegativeInteractions(@Param("negativeTypes") List<FeedbackType> negativeTypes,
      Pageable pageable);
