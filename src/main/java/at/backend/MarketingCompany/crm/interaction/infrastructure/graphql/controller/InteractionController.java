...
public class InteractionController {
    ...
    @QueryMapping
    public List<InteractionResponse> interactions(@Argument PageInput pageInput, @Argument InteractionFilterInput filter) {
    ...
    @QueryMapping
    public PageResponse<InteractionResponse> interactionsByCustomer(@Argument String customerId, @Argument PageInput pageInput) {
    ...
    @QueryMapping
    public PageResponse<InteractionResponse> interactionsByFeedbackType(@Argument String feedbackType, @Argument PageInput pageInput) {
    ...
    public InteractionResponse createInteraction(@Valid @Argument CreateInteractionInput input) {
        ...
        var command = new CreateInteractionCommand(
            ...
            input.type(),
            at.backend.MarketingCompany.crm.interaction.domain.entity.valueobject.InteractionDateTime.from(input.dateTime()),
            at.backend.MarketingCompany.crm.interaction.domain.entity.valueobject.InteractionDescription.from(input.description()),
            at.backend.MarketingCompany.crm.interaction.domain.entity.valueobject.InteractionOutcome.from(input.outcome()),
            input.feedbackType(),
            at.backend.MarketingCompany.crm.interaction.domain.entity.valueobject.ChannelPreference.from(input.channelPreference())
        );
