...
public class TaskEntityMapper {
    ...
    public TaskEntity toEntity(Task task) {
        ...
        task.getAssignedTo().ifPresent(assignedTo -> {
            var user = new User(assignedTo.value());
    ...
    public Task toDomain(TaskEntity entity) {
        ...
        var reconstructParams = TaskReconstructParams.builder()
            ...
            .dueDate(entity.getDueDate() != null ? 
                DueDate.from(entity.getDueDate()) : null)
            .status(entity.getStatus())
            .priority(entity.getPriority())
            .assignedTo(entity.getAssignedTo() != null ? 
                new EmployeeId(entity.getAssignedTo().getId()) : null)
