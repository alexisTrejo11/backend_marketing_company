package at.backend.MarketingCompany.crm.deal.v2.domain.entity;

import at.backend.MarketingCompany.crm.Utils.enums.DealStatus;
import at.backend.MarketingCompany.crm.deal.v2.domain.entity.valueobject.*;
...
import at.backend.MarketingCompany.crm.deal.v2.domain.exceptions.DealStatusTransitionException;
...
public class Deal extends BaseDomainEntity<DealId> {
    ...
    public static Deal create(CreateDealParams params) {
        ...
        newDeal.period = new ContractPeriod(params.startDate(), null);
        newDeal.finalAmount = FinalAmount.zero();
        newDeal.createdAt = LocalDateTime.now();
        newDeal.updatedAt = LocalDateTime.now();
        newDeal.version = 1;
    ...
    public void completeDeal(LocalDate endDate, String finalDeliverables) {
        ...
        this.period = new ContractPeriod(this.period.startDate(), endDate);
