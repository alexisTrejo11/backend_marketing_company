...
public record CompanyProfile(
    ...
    AnnualRevenue revenue, String missionStatement,
    String targetMarket, Set<String> competitorUrls,
  ...
  public boolean competesWith(String competitor) {
    return competitorUrls != null
        && competitorUrls.stream().anyMatch(url -> url.toLowerCase().contains(competitor.toLowerCase()));
  }
