package at.backend.MarketingCompany.customer.core.application.dto.query;
...
public class CompanyQueries {
    ...
    @Builder
    public static record GetCompanyMetricsQuery(Optional<CustomerCompanyId> companyId) {
