...
public class CustomerCompanyQueryHandlerImpl implements CustomerCompanyQueryHandler {
    ...
    public CustomerCompany handle(GetCompanyByIdQuery query) {
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<CustomerCompany> handle(GetAllCompaniesQuery query) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<CustomerCompany> handle(SearchCompaniesQuery query) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<CustomerCompany> handle(GetCompaniesByIndustryQuery query) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<CustomerCompany> handle(GetCompaniesByStatusQuery query) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<CustomerCompany> handle(GetHighValueCompaniesQuery query) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<CustomerCompany> handle(GetStartupsQuery query) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<CustomerCompany> handle(GetCompaniesWithExpiringContractsQuery query) {
    ...
    @Override
    @Transactional(readOnly = true)
    public boolean handle(IsCompanyActiveQuery query) {
    ...
    @Override
    @Transactional(readOnly = true)
    public boolean handle(HasActiveContractQuery query) {
    ...
    @Override
    @Transactional(readOnly = true)
    public CompanyMetrics handle(GetCompanyMetricsQuery query) {
