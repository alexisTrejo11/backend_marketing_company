 ...
 * requests to a different domain than the one serving the web page. This package provides
 * flexible CORS configuration to allow legitimate cross-origin requests while maintaining security.
 * </p>
 *
 * <h2>Why CORS?</h2>
 * <p>
 ...
 * <ul>
 *   <li><b>Frontend:</b> React/Vue/Angular app hosted on {@code https://app.example.com}</li>
 *   <li><b>Backend API:</b> Spring Boot API hosted on {@code https://api.example.com}</li>
 * </ul>
 * Without CORS configuration, browsers would block the frontend from accessing the API.
 * </p>
 *
 * <h2>Architecture</h2>
 * <ul>
 *   <li>{@link at.backend.MarketingCompany.config.cors.CorsConfig} - Main CORS configuration</li>
 *   <li>{@link at.backend.MarketingCompany.config.cors.CorsProperties} - CORS settings from application.yml</li>
 * </ul>
 *
 * <h2>Configuration</h2>
 *
 ...
 *     <td>http://localhost:3000<br>http://localhost:5173</td>
 *     <td>https://app.example.com<br>(specific domains only)</td>
 *   </tr>
 *   <tr>
 ...
 * <p>For simple GET/POST requests with standard headers:</p>
 * <ol>
 ...
 * <p>For complex requests (PUT/DELETE, custom headers, credentials):</p>
 * <ol>
 ...
 * <p>
 * You <b>CANNOT</b> use {@code allowCredentials: true} with {@code allowedOrigins: ["*"]}.
 ...
 *   <dd>
 *     <b>Cause:</b> CORS configured in multiple places (Spring Security + WebMvcConfigurer)<br>
 *     <b>Solution:</b> Configure CORS in only one place (use our CorsConfig)
 *   </dd>
 *
 *   <dt>"Credential is not supported if the CORS header 'Access-Control-Allow-Origin' is '*'"</dt>
 *   <dd>
 ...
 *   <li><b>Enable credentials only if needed</b> - If not using cookies/auth headers, set to false</li>
 *   <li><b>Expose only necessary headers</b> - Don't expose sensitive information</li>
 *   <li><b>Set appropriate max-age</b> - Balance between performance and security</li>
 ...
 *   <li><b>Monitor CORS errors</b> - Log failed CORS requests for security analysis</li>
 * </ol>
 *
 ...
 * <p>
 * CORS works seamlessly with GraphQL endpoints. All GraphQL requests (queries, mutations, subscriptions)
 * respect CORS configuration. Rate limit headers are automatically exposed in CORS responses.
 * </p>
 *
 * @see at.backend.MarketingCompany.config.cors.CorsConfig
 * @see at.backend.MarketingCompany.config.cors.CorsProperties
 * @see at.backend.MarketingCompany.config.security.SecurityConfig
 *
 * @author Alexis Trejo
 * @version 2.0.0
 * @since 2.0.0
